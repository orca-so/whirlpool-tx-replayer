...
pub fn replay(req: ReplayInstructionParams<decoded_instructions::DecodedOpenPositionWithMetadata>, replayer: &mut util_bank::ReplayEnvironment) -> ReplayInstructionResult {
