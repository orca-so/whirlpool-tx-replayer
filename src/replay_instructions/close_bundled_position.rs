...
pub fn replay(req: ReplayInstructionParams<decoded_instructions::DecodedCloseBundledPosition>, replayer: &mut util_bank::ReplayEnvironment) -> ReplayInstructionResult {
