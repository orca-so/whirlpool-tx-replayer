...
pub fn replay(req: ReplayInstructionParams<decoded_instructions::DecodedIncreaseLiquidity>, replayer: &mut util_bank::ReplayEnvironment) -> ReplayInstructionResult {
