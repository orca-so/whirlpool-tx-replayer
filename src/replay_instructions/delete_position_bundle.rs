...
pub fn replay(req: ReplayInstructionParams<decoded_instructions::DecodedDeletePositionBundle>, replayer: &mut util_bank::ReplayEnvironment) -> ReplayInstructionResult {
